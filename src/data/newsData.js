export const newsArticles = [
  {
    ...
    date: 'July 22, 2025',
    readTime: '5 min read',
    image: 'https://images.ctfassets.net/xlosfajxk15z/60JFk83PKaYmyeefFkg9sz/1c8fc704c5fc9e891b062e4f76c98c56/fort.png',
  ...
  },
  {
    ...
    date: 'July 21, 2025',
    readTime: '4 min read',
    image: 'https://images.squarespace-cdn.com/content/v1/677da3effd27534943aafe30/t/6797d411eee88c3f1ad719b3/1738003476662/pyra-pilates.jpg?format=1500w',
  ...
  },
  {
    ...
    date: 'July 20, 2025',
    readTime: '4 min read',
    image: 'https://images.squarespace-cdn.com/content/v1/64cfe419804aff292781cf4d/t/67aa856799aa8f7c41270bb7/1739228525849/IVR56195.jpg?format=1500w',
  ...
  },
  {
    ...
    date: 'July 18, 2025',
    readTime: '4 min read',
    image: 'https://www.sqlptpilates.com/api/media/file/DSC07157-Enhanced-NR.webp?2025-04-16T15:54:13.027Z',
  ...
  },
  {
    ...
    content: `
      ...
      <h3>The Shift From Transactional to Narrative-Driven Marketing</h3>
      <p>Today's affluent buyers are not simply purchasing square footage; they are acquiring a lifestyle, a legacy, and a piece of historic coastal elegance. High-converting real estate branding in Palm Beach hinges on restraint, authentic craftsmanship, and editorial storytelling.</p>
      
      <h3>Key Visual Identity Pillars for Palm Beach Developers</h3>
      <ul>
        <li><strong>Bespoke Serif Typography:</strong> Custom or curated editorial typefaces that evoke heritage and timelessness.</li>
        <li><strong>Subtle Architectural Color Palettes:</strong> Replacing harsh tones with warm toasted creams, sun-bleached terracotta, and muted ocean blue.</li>
        <li><strong>Tactile Print & Digital Synergy:</strong> Linen-bound hard-backed property books paired with ultra-responsive, cinematic web experiences.</li>
      </ul>
      
      <p>At Intent Digital, we work hand-in-hand with luxury real estate developers and boutique agencies across South Florida to build brand identities that command authority from day one.</p>
    `
  },
  {
    ...
    content: `
      ...
      <h3>Upcoming High-Profile Restaurant Openings</h3>
      <p>Several renowned hospitality groups are preparing to open flagship waterfront dining concepts along the New River corridor and Las Olas. Expect Mediterranean coastal dining, omakase concepts, and rooftop lounges with panoramic skyline views.</p>
      
      <h3>Retail Transformation & Concept Design</h3>
      <p>Boutique fashion houses, artisan perfumeries, and interior design showrooms are curating immersive flagship storefronts. For retail and hospitality brands, distinct brand identity and interior cohesion are the foundation for standing out on Las Olas.</p>
    `
  },
  {
    ...
    content: `
      ...
      <h3>Building Developer Authority in Boca Raton</h3>
      <p>From private golf communities to waterfront high-rises along Royal Palm Way, developers who invest in comprehensive brand guidelines and custom web architecture achieve faster presales and higher price-per-square-foot valuations.</p>
    `
  },
  {
